...
//        model.addAttribute("userDetail", userDetail);
    ...
    public String publish(Article article, HttpSession session, HttpServletRequest request) {
        ...
        try {
            //发布操作代码
            String res = articleFallbackFeign.publishArticle(article);
...
//        List<Article> articles = articleFallbackFeign.selectAllArticleByCreated();
...
//            List<Article> articles = articleFallbackFeign.queryArticleByTitle(title);
//
...
//        } else {
//            PageHelper.startPage(page, limit);
//            List<Category> categories = categoryFallbackFeign.selectCategories();
//
